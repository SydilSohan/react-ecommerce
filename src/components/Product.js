...
<button className=' flex-shrink mx-auto my-4 text-white duration-300 hover:text-black bg-black px-2 py-3 rounded-md flex justify-center items-center text-center hover:bg-white border-[1px] hover:border-slate-300 border-transparent' onClick={() => addToCart(product)}>
             <span >Add to Cart</span> <FiPlus className=' mx-2' />
