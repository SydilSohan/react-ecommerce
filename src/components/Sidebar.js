...
const Sidebar = () => {
  ...
  return (
    <div className={isOpen ? "z-50  bg-white shadow-2xl h-screen w-full sm:w-3/6 md:w-3/6 lg:w-3/12 fixed top-0 right-0 transition-all duration-300 overflow-hidden ease-linear" : "z-50 p-4 bg-white shadow-2xl h-screen w-full sm:w-2/6 md:w-3/6 lg:w-3/12 fixed top-0 -right-full transition-all duration-500 ease-linear overflow-hidden"}>
